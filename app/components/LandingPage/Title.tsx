...
const Title = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-0 mt-36">
      ...
      <h1
        id="banner-text"
        className="overflow-hidden opacity-0 text-[2.75rem] jaldi lg:text-[6rem] tracking-[0.25rem] lg:tracking-[0.5rem] leading-[3rem] lg:leading-[6rem] my-4 uppercase text-black dark:text-white"
      >
        CityBizScout
      </h1>
    </div>
